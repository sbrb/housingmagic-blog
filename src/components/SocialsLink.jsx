...
export const socials = [
  ...
  {
    outlet: "Email",
    href: "mailto:?subject=Beginner's%20GuidetoJest%20Testing%20inReact&body=https://dev.to/dsasse07/beginner-s-guide-to-jest-testing-in-react-1nig%20CheckoutthisnewarticleonJest%20testinginReact!",
    background: "#dd4b39",
    color: "white",
    label: "ShareviaEmail",
